...
UCODE_ARITHMETIC_FUNCTIONS = {FUNC_ADD : UCODEArithFunc(FUNC_ADD, lambda x, y: x+y),
                              ...
                              FUNC_NOR : UCODEArithFunc(FUNC_NOR, lambda x, y: ~(x|y)),
                              FUNC_MUL : UCODEArithFunc(FUNC_MUL, lambda x, y: x*y),
                              FUNC_SLT : UCODEArithFunc(FUNC_SLT, lambda x, y: int(x<y)),
...
UCODE_SHIFT_FUNCTIONS = {FUNC_SHR : UCODEArithFunc(FUNC_SHR, lambda x, y: x>>y),
                         ...
                         FUNC_SAR : UCODEArithFunc(FUNC_SAR, lambda x, y: x>>y if x >= 0 else 0xFF) ##@todo this is unimplemented - data size dependant
